...
exports.UserError = (function() {
    var UserError = function(message) {
        this.message = message // Error.call(this, message) doesn't work
        this.name = "UserError"
    }
...
exports.request = function(args, callback) {
    ...
    exports.handledCallback(callback, function() {
        request(args, exports.handledCallback(callback, function(error, response, body) {
...
exports.download = function(url, callback) {
   this.request({ url: url, encoding: 'binary' }, exports.handledCallback(callback, function(error, response, body) {
       if (error) throw error
       temp.open('download', exports.handledCallback(callback, function(error, file) {
           if (error) throw error
           fs.write(file.fd, body, null, 'binary', exports.handledCallback(callback, function(error) {
               if (error) throw error
...
exports.exec = function(command, args, callback) {
    ...
    var spawned = child_process.spawn(command, args)
